...
const { address, getAddress } = useStore('section');
const { verifyAuthCount, isExceedLimit, getSlides, slides } = useStore('slides');
...
function generateQRCode() {
  ...
  new QRCode(QRCodeRef.value, {
    text: `https://luojigou.vip/singlepage/#/homeCard?id=${slides.value.slidesId}`,
    width: 280,
    height: 280,
    colorDark: '#000000',
    colorLight: '#ffffff'
